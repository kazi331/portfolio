        ...
        <div className="w-full mx-auto">
            <section id="home" className="min-h-screen container flex items-center mx-auto text-gray-300">
                <div className="w-full md:w-9/12 xl:w-8/12 px-4 py-24 pb-20">
                    ...
                    <a href={resume} target="_blank" rel='noreferrer' download className=" text-white bg-[#00ffc6] bg-opacity-5  border-2 border-[#00ffc881] p-3 focus:outline-none hover:bg-[#00ffc6] hover:bg-opacity-20 rounded">Download Resume</a>
