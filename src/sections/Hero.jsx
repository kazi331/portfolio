...
const Hero = () => {
    return (
        <div className="hero w-full md:w-9/12 xl:w-8/12 px-4 py-24 pb-20" >
            ...
            <a area-label="Download Resume" href={resume} target="_blank" rel='noreferrer' download className=" text-white bg-[#00ffc6] bg-opacity-5  border-[1px] border-[#00ffc881] p-3 focus:outline-none hover:bg-[#00ffc6] hover:bg-opacity-10 rounded">Download Resume</a>
        </div>
    );
};
