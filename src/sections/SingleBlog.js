...
const SingleBlog = () => {
    return (
        <div className="p-4 md:w-1/2 lg:w-1/3 ">
            <div className="h-full p-4 flex shadow-lg border-b-[1px] transition-all border-transparent hover:border-[#01F7C0] bg-[#1E212B] bg-opacity-40 rounded-lg overflow-hidden">
                ...
                <div className="flex-grow pl-6">
                    ...
                    <a area-label="post title" href="#!" className="title-font text-xl py-1 inline-block font-medium text-gray-300 hover:text-[#00ffc6] mb-3">Post Title goes here</a>
                    ...
                    <a area-label="me" href='https://github.com/kazi331' className="inline-flex items-center">
